...
import space.qu4nt.entanglementlib.exception.security.EntLibCertificateException;
...
public class TBSData {
    ...
    public X509CertificateHolder toX509v3Certificate(final @NotNull String algorithm,
                                                     ...
                                                     boolean isRootCA) throws OperatorCreationException, CertIOException {
        ...
        if (certificateVersion != 3)
            throw new EntLibCertificateException(TBSData.class, "unsupported-ver-exc", certificateVersion);
