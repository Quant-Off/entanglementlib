...
package space.qu4nt.entanglementlib.security.legacy;
...
import space.qu4nt.entanglementlib.security.legacy.certificate.EntSSL;
import space.qu4nt.entanglementlib.security.legacy.certificate.KeyStoreManager;
...
public class EntTCP {
    ...
    public EntTCP(final char @NotNull [] password, int port, PrivateKey serverPrivateKey, X509Certificate... serverCertificateChain)
            throws GeneralSecurityException, IOException, EntLibSecureJCAJCEStoreProcessException {
        this.port = port;
     ...
     */
    public void start(final char @NotNull [] password) throws IOException, EntLibSecureCertProcessException {
        if (running) {
