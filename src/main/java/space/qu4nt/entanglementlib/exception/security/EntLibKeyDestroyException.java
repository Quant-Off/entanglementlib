...
public class EntLibKeyDestroyException extends EntLibSecurityException {
     ...
     * @param fullKey 메시지 키
     */
    public <T> EntLibKeyDestroyException(Class<T> clazz, @NotNull String fullKey) {
        super(clazz, fullKey);
    }
     ...
     */
    public <T> EntLibKeyDestroyException(Class<T> clazz, @NotNull String fullKey, Object... args) {
