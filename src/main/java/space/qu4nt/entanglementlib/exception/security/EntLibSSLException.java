 ...
 * @since 1.0.0
 */
public class EntLibSSLException extends EntLibSecurityException {
     ...
     */
    public <T> EntLibSSLException(Class<T> clazz, @NotNull String fullKey, Object... args) {
     ...
     * @param cause   발생한 예외
     */
    public <T> EntLibSSLException(Class<T> clazz, @NotNull String fullKey, @NotNull Throwable cause) {
