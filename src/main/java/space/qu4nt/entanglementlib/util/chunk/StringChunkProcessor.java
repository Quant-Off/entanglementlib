...
/**
 * 문자열을 청크 단위로 처리하기 위한 클래스입니다.
 *
 * @author Q. T. Felix
 * @since 1.0.0
 */
public class StringChunkProcessor {

    /**
     * 대용량 문자열을 청크 단위로 처리하기 위한 메소드입니다.
     * <p>
     ...
     */
    public static void processInChunks(String data, int chunkSize, ChunkProcessor<String> processor, boolean parallel) {
        ...
        range.forEach(start -> {
            ...
            try {
                ...
                throw new RuntimeException("An exception occurred during chunk operation at offset " + start, e);
            }
        });
    }
     ...
     * @throws RuntimeException         처리 중 예외 발생 시
     */
    public static void processInChunks(String data, int chunkSize, ChunkProcessor<String> processor) {
