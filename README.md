...
[![README-Language](https://img.shields.io/badge/README-Korean_Ver-blue?style=for-the-badge)](README_KR.md)
...
|----------|---------------------------------------------------------------------|
| Digest   | `FipsSHS` SHA-2 / SHA-3 (FIPS approved)                             |
| SHAKE    | `FipsSHS` SHAKE128 / SHAKE256 XOF (FIPS approved)                   |
| AEAD     | `ChaCha20-Poly1305` (RFC 8439, **not FIPS approved**)               |
| Random   | `FipsDRBG` HMAC-DRBG-SHA512 (NIST SP 800-90A, prediction resistant) |
| Encoding | `Base64` / `Hex`                                                    |
